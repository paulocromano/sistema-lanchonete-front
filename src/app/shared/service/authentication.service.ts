...
export class AuthenticationService {
  ...
  public autenticarUsuario(credenciaisUsuario: CredenciaisUsuario): Observable<any> {
    return this.http.post(`${this.servidorService.urlServidorBackEnd}/login`, credenciaisUsuario,
    {
      observe: 'response',
      responseType: 'text'
    });
  ...
  public logout(): Observable<any> {
    return this.http.post(`${this.servidorService.urlServidorBackEnd}/logout`, {});
  }
}
